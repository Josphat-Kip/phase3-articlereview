...
This challenge has three models: User,Review and Product

Product has many Users, a User has many Products’ s, and a Review belongs to a User and to a Product.
